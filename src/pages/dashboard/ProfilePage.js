                                ...
                                <Form onSubmit={handleProfileUpdate} className={styles.contactForm}>
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <Form.Control type="text" defaultValue={userProfile.firstName} className={styles.contactInput} required onChange={(e) => setProfile({ ...profile, firstName: e.target.value })} placeholder="Samuel Emmanuel"></Form.Control>
                                        </div>
                                        <div className="col-md-6">
                                            <Form.Label className={styles.contactLabel}>Last Name  <span style={{ color: "#FF0000" }}>*</span></Form.Label>
                                            <Form.Control type="text" defaultValue={userProfile.lastName} className={styles.contactInput} required onChange={(e) => setProfile({ ...profile, lastName: e.target.value })} placeholder="Samuel Emmanuel"></Form.Control>
                                        </div>
                                        <div className="col-md-6">
